...
<html>
    <head>
        <link rel="shortcut icon" href="img/onlineauctionsystem.jpg" />
           ...
           <div id="bannerImage">
               <div class="container">
                   ...
                   <div id="bannerContent">
                       <h1>We sell best auction items</h1>
               ...
               <div class="row">
                   ...
                   <div class="col-xs-4">
                       <div class="thumbnail">
                           ...
                           <center>
                               <div class="caption">
                                   <p id="autoResize">Statues</p>
                                   <p>Our authentic collection of statues.</p>
                               </div>
                           </center>
                       </div>
                   </div>
