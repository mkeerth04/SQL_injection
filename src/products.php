	...
	if(isset($_POST['search']))
	{
		if(!empty($_POST['search']))
		{
			...
			if(mysqli_multi_query($con,$query))
			{
				...
				echo "<font color=\"red\"><h3></h3></font>";
		}
		else
		{
			echo "<font color=\"red\"><h3>* Please enter Product name to search.</h3></font>";
		}
	}
?>
            ...
            <div class="container">
				...
				<div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/budhha.jpg" alt="Buddha">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Buddha</h3>
                                    <p>Price: Rs.33500.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                                        }
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Ancient Art History.jpg" alt=" Ancient Art History">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3> Ancient Art History</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Gandhara_Buddha.jpeg" alt="Gandhara Buddha">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Gandhara Buddha</h3>
				...
				<div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Cave Art.jpg" alt="Cave Art">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Cave art</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/Tamatina.jpg" alt="Tamatina painting">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Tamatina painting</h3>
                                    <p>Price: Rs.40000.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/The-Hunter-Madhubani-painting.jpg" alt="The hunter Madhubani">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>The hunter Madhubani</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/phad.jpg" alt="Phad painting">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Phad painting</h3>
